...
const Register = () => {
    ...
    const getInit=async (): Promise<void> => {
        try{
            ...
            if(data.isSuccess){
                const result = await authApiRequest.registerGoogle(data.data);
                ...
                <div className="w-[30%] bg-white rounded-lg shadow-custom border border-gray-700 relative">
                    ...
                    <div className="px-6 py-3 space-y-2">
                        ...
                        <form className="space-y-1" onSubmit={onSubmit}>
                            ...
                            {errAction && (<p className='text-lg text-center text-red-500 font-semibold'>
                                <ExclamationTriangleIcon className='h-[1.5rem] w-[1.5rem] inline-block -mt-1'></ExclamationTriangleIcon>
                                {errAction}
                            </p>)}
                            ...
                            <div className='flex flex-row justify-center items-center gap-3'>
                                <Button className={"cursor-pointer"} onClick={(event: React.MouseEvent<HTMLButtonElement>)=>{
                                    event.preventDefault();
                                    setIsLoading(true);
                                    signIn("google");
                                }}>
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
                                        ...
                                        <path fill="#e53935" d="M6.306,14.691l6.571,4.819C14.655,15.108,18.961,12,24,12c3.059,0,5.842,1.154,7.961,3.039	
                                        l5.657-5.657C34.046,6.053,29.268,4,24,4C16.318,4,9.656,8.337,6.306,14.691z"></path>
                                        <path fill="#4caf50" d="M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36 
                                        c-5.202,0-9.619-3.317-11.283-7.946l-6.522,5.025C9.505,39.556,16.227,44,24,44z"></path>
                                        <path fill="#1565c0" d="M43.611,20.083L43.595,20L42,20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571	
