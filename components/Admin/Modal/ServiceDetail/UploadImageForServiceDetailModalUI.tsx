...
const UploadImageForServiceDetailModalUI = ({closeModel, idServiceDetail, refreshAllServiceDetailUpdate}:Props) => {
    ...
    const getUrlFileInit=async ():Promise<void>=>{
        try{
            await serviceDetailApiRequest.getServiceDetailById({id:idServiceDetail,fields: "?fields=PathUrl"}).then((res)=>{
    ...
    const eventUploadImage = async ():Promise<void>=>{
        ...
        try{
            ...
            await serviceDetailApiRequest.uploadImageServiceDetail({id:idServiceDetail,body:formData}).then((res)=>{
                if(res.payload.data){
                    showToast("success", <p>{res.payload.message}</p>)
                    refreshAllServiceDetailUpdate();
                }
                else{
...
export default UploadImageForServiceDetailModalUI